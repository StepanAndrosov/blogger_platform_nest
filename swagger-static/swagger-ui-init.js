...
window.onload = function() {
  ...
  "swaggerDoc": {
    ...
    "paths": {
      ...
      "/api/blogs/{id}": {
        "get": {
          "operationId": "BlogsController_getById",
          "parameters": [
            {
              "name": "id",
              "required": true,
          ...
          "responses": {
            "200": {
              ...
              "content": {
                "application/json": {
                  "schema": {
                    "$ref": "#/components/schemas/BlogOutputModel"
                  }
                }
              }
            }
      ...
      "/api/blogs/{blogId}/posts": {
        ...
        "post": {
          "operationId": "BlogsController_createPosts",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/PostCreateFromBlogModel"
                }
              }
            }
          },
          ...
          "responses": {
            "200": {
              ...
              "content": {
                "application/json": {
                  "schema": {
                    "$ref": "#/components/schemas/PostOutputModel"
                  }
                }
              }
            }
      ...
      "/api/comments/{id}": {
        "get": {
          "operationId": "CommentsController_getById",
          "parameters": [
            {
              "name": "id",
              "required": true,
          ...
          "responses": {
            "200": {
              ...
              "content": {
                "application/json": {
                  "schema": {
                    "$ref": "#/components/schemas/CommentOutputModel"
                  }
                }
              }
            }
